...
sudo wget -qO- https://github.com/concourse/concourse/releases/download/v$CONCOURSE_VERSION/concourse-$CONCOURSE_VERSION-linux-amd64.tgz | tar xvz - -C /usr/local/bin/concourse
